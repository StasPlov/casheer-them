<template>
    <div class="bg-[var(--color-black1)] relative overflow-hidden">
        <div class="flex max-md:flex-col-reverse">
            ...
            <div
                class="flex items-center justify-center absolute right-[21vw] top-12 max-md:top-0 max-md:relative max-md:right-0 max-md:justify-start max-md:px-[7vw] max-md:py-[2vw]"
            >
