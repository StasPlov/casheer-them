<template>
    <div class="bg-[var(--color-black1)] relative overflow-hidden">
        <div class="flex max-md:flex-col-reverse">
            ...
            <div
                class="flex items-center justify-center absolute left-[7vw] top-28 max-md:top-0 max-md:relative max-md:left-0 max-md:justify-start max-md:px-[7vw] max-md:py-[2vw]"
            >
                <div class="flex flex-col gap-4">
                    ...
                    ></span>
                    <span
                        class="text-white text-xl font-[Arial] font-semibold max-md:hidden"
                        v-html="description"
                    ></span>
                </div>
            </div>
